...
class GetRegisterAtBlockIDRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetRegisterAtBlockIDRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'flow.execution'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registerController', $pb.PbFieldType.OY)
  ...
  factory GetRegisterAtBlockIDRequest({
    ...
    $core.List<$core.int>? registerController,
    ...
    if (registerController != null) {
      _result.registerController = registerController;
    }
    if (registerKey != null) {
  ...
  @$pb.TagNumber(3)
  $core.List<$core.int> get registerController => $_getN(2);
  @$pb.TagNumber(3)
  set registerController($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasRegisterController() => $_has(2);
  @$pb.TagNumber(3)
  void clearRegisterController() => clearField(3);

  @$pb.TagNumber(4)
  $core.List<$core.int> get registerKey => $_getN(3);
  @$pb.TagNumber(4)
  set registerKey($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasRegisterKey() => $_has(3);
  @$pb.TagNumber(4)
